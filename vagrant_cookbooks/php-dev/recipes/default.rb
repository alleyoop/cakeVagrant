...
packages = %w{git subversion nginx php5 php5-mysql php5-curl php5-cli php5-fpm php-pear mysql-server curl imagemagick php5-imagick php5-gd libimlib2 php-imlib memcached php5-memcache}
